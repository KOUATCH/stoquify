import type { EvidenceGrade, ProofTrailBlockerSeverity } from "@/services/evidence/evidence-contracts"
...
export type SnapshotStatus = "fresh" | "stale" | "partial" | "blocked" | "building" | "failed" | "empty"
