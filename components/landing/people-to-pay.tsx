        ...
        <div className="mt-8 grid overflow-hidden rounded-lg bg-[#10181d] text-white shadow-[0_24px_70px_rgba(16,24,29,0.20)] lg:grid-cols-[1.1fr_0.9fr]">
          <div className="border-b border-white/10 p-6 lg:border-b-0 lg:border-r lg:p-8">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link href="/#pricing" className="inline-flex items-center gap-2 rounded-lg bg-[var(--color-brand-action)] px-4 py-2.5 body-text text-sm font-semibold text-white transition hover:bg-[var(--color-brand-hover)]">
                {t("peopleCta")}
                <ArrowRight className="size-4" aria-hidden="true" />
              </Link>
              <Link href="/#pricing" className="inline-flex items-center gap-2 rounded-lg border border-white/20 px-4 py-2.5 body-text text-sm font-semibold text-white transition hover:bg-white/[0.07]">
                {t("payrollCta")}
                <ArrowRight className="size-4" aria-hidden="true" />
              </Link>
            </div>
