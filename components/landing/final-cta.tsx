  ...
  return (
    <section id="get-started" className="relative isolate overflow-hidden bg-[var(--ink-0)] px-6 py-24 text-center lg:px-8">
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <Link href="/#pricing" className="mt-9 inline-flex items-center gap-2 rounded-lg bg-[var(--color-brand-action)] px-6 py-3 body-text text-sm font-semibold text-white transition hover:bg-[var(--color-brand-hover)]">
          {t("cta")}
