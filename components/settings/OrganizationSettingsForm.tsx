...
const copy = {
  en: {
    ...
    title: "Company DNA",
    subtitle: "Keep the business identity, locale, calendar, and regional defaults aligned across StockFlow.",
  ...
  fr: {
    ...
    subtitle: "Gardez l'identite, la langue, le calendrier et les parametres regionaux alignes dans StockFlow.",
