...
const inventoryHistoryTransactionTypeSchema = z.enum([
  "PURCHASE_RECEIPT",
  "SALES_RETURN",
  "TRANSFER_IN",
  "ADJUSTMENT_IN",
...
const inventoryHistoryBackgroundExportFiltersSchema = z
  .object({
    itemId: z.string().min(1).optional(),
    locationId: z.string().min(1).optional(),
    type: inventoryHistoryTransactionTypeSchema.optional(),
...
const enqueueSchema = z
  .object({
    ...
    filters: inventoryHistoryBackgroundExportFiltersSchema.optional(),
