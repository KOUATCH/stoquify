...
description: Create ledger-backed reports, source-linked exports, accountant access, data trust metadata, and statutory reporting packs. Use when reports, dashboards, exports, accountant portal, statutory reports, data provenance, source links, or report certification in the AqStoqFlow/OHADA SMB platform, especially when implementing the numbered skill suite with gates, errors, notifications, evidence, and enterprise release discipline.
---

# Data Trust Accountant Portal
...
Previous required skill: `012-aqstoqflow-payroll-presence-engine`.
Next recommended skill: `014-aqstoqflow-offline-pos-sync`.

## Focus

Trustworthy reporting and accountant collaboration.
