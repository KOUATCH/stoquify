...
description: Review any chunk before promotion using tenant, RBAC, ledger, event, immutability, error, notification, UI, observability, and test gates. Use when reviewing a completed AqStoqFlow chunk, approving release readiness, rejecting unsafe work, or validating promotion gates in the AqStoqFlow/OHADA SMB platform, especially when implementing the numbered skill suite with gates, errors, notifications, evidence, and enterprise release discipline.
---
...
Previous required skill: `016-aqstoqflow-ai-copilot-guardrails`.

## Focus

Release approval, required fixes, and rejection evidence.
