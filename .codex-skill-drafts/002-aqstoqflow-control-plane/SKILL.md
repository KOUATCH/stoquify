...
description: Build tenant isolation, RBAC, module gates, step-up assurance, audit policy, and maker-checker controls. Use when tenant scope, RBAC, permissions, role policy, module gating, step-up authentication, maker-checker, or audit controls in the AqStoqFlow/OHADA SMB platform, especially when implementing the numbered skill suite with gates, errors, notifications, evidence, and enterprise release discipline.
---
...
Previous required skill: `001-aqstoqflow-program-orchestrator`.
Next recommended skill: `003-aqstoqflow-error-notification-foundation`.

## Focus

Tenant and authorization control plane for every regulated workflow.
