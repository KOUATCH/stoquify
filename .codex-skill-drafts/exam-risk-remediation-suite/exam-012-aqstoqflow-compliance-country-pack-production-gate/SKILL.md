---
name: exam-012-aqstoqflow-compliance-country-pack-production-gate
description: Exam 012 Compliance Country Pack Gate remediates AqStoqFlow risk class 012 by move compliance and country-pack readiness toward production without allowing fake statutory claims. Use when executing the ordered exam risk-remediation suite, hardening this risk area, migrating legacy code into service-owned workflows, adding OHADA controls, or validating this remediation gate.
---

# Exam 012 Compliance Country Pack Gate

Use this skill to move compliance and country-pack readiness toward production without allowing fake statutory claims.

## Runtime Boundary

Risk class: Compliance adapters and Cameroon country-pack values still include sandbox and expert-review blockers, so legal production certification must remain blocked.
...
- expert review blocker.
- sandbox-only blocker.
- adapter not configured.
- country-pack version provenance.
