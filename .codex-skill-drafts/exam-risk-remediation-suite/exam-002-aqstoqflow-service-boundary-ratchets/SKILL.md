---
name: exam-002-aqstoqflow-service-boundary-ratchets
description: Exam 002 Service Boundary Ratchets remediates AqStoqFlow risk class 002 by add and ratchet service-boundary gates that detect direct Prisma access outside services and action-owned economic mutations. Use when executing the ordered exam risk-remediation suite, hardening this risk area, migrating legacy code into service-owned workflows, adding OHADA controls, or validating this remediation gate.
---

# Exam 002 Service Boundary Ratchets

Use this skill to add and ratchet service-boundary gates that detect direct Prisma access outside services and action-owned economic mutations.

## Runtime Boundary

Risk class: Direct Prisma in App Router, components, hooks, or server actions can bypass tenant scope, RBAC, typed errors, audit evidence, and service-owned business rules.
...
- scanner fixture tests when a scanner is added.
- focused action/service regression tests for migrated callers.
