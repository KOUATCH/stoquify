---
name: exam-005-aqstoqflow-purchasing-ap-consolidator
description: Exam 005 Purchasing AP Consolidator remediates AqStoqFlow risk class 005 by resolve split ownership between legacy purchase-order workflows and newer purchasing/AP controls. Use when executing the ordered exam risk-remediation suite, hardening this risk area, migrating legacy code into service-owned workflows, adding OHADA controls, or validating this remediation gate.
---

# Exam 005 Purchasing AP Consolidator

Use this skill to resolve split ownership between legacy purchase-order workflows and newer purchasing/AP controls.

## Runtime Boundary

Risk class: AP controls can be bypassed through legacy purchase-order code with raw errors, direct Prisma orchestration, hard deletes, and old receiving workflows.
