---
name: exam-006-aqstoqflow-hard-delete-immutability-gate
description: Exam 006 Hard Delete Immutability Gate remediates AqStoqFlow risk class 006 by classify and eliminate unsafe hard deletes for evidence-bearing records while adding a reusable hard-delete policy gate. Use when executing the ordered exam risk-remediation suite, hardening this risk area, migrating legacy code into service-owned workflows, adding OHADA controls, or validating this remediation gate.
---

# Exam 006 Hard Delete Immutability Gate

Use this skill to classify and eliminate unsafe hard deletes for evidence-bearing records while adding a reusable hard-delete policy gate.

## Runtime Boundary

Risk class: Hard deletes can remove economic or audit evidence and bypass cancellation, reversal, soft-delete, or corrective event discipline.
...
- forbidden delete of final records.
- draft cleanup allowed.
- soft delete audit evidence.
- reversal/cancellation evidence.
