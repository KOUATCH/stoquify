...
description: Implement payment evidence ingestion, matching, suspense, mobile money, bank/card reconciliation, and certification workflows. Use when payment reconciliation, mobile money, bank statements, card settlements, suspense, matching, treasury, or reconciliation certification in the AqStoqFlow/OHADA SMB platform, especially when implementing the numbered skill suite with gates, errors, notifications, evidence, and enterprise release discipline.
---
...
Previous required skill: `008-aqstoqflow-compliance-center`.
Next recommended skill: `010-aqstoqflow-inventory-valuation-kernel`.

## Focus

Evidence-backed reconciliation and treasury controls.
