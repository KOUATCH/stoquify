...
description: Implement the durable business event envelope, idempotency, outbox, audit linkage, and replay-safe processing. Use when business events, outbox, idempotency, audit trails, replay, workers, or atomic domain mutations in the AqStoqFlow/OHADA SMB platform, especially when implementing the numbered skill suite with gates, errors, notifications, evidence, and enterprise release discipline.
---
...
Previous required skill: `003-aqstoqflow-error-notification-foundation`.
Next recommended skill: `005-aqstoqflow-accounting-control-center`.

## Focus

Ledger-first business events and reliable asynchronous processing.
