...
description: Turn the OHADA SMB platform roadmap into tracked implementation chunks, dependencies, gates, and release evidence. Use when starting the platform build, planning chunks, sequencing work, tracking dependencies, or defining acceptance criteria in the AqStoqFlow/OHADA SMB platform, especially when implementing the numbered skill suite with gates, errors, notifications, evidence, and enterprise release discipline.
---
...
Next recommended skill: `002-aqstoqflow-control-plane`.

## Focus

Program baseline, chunk tracker, skill coordination, and implementation governance.
...
- selected skill: `001-aqstoqflow-program-orchestrator`
- files changed
- gates passed
- gates blocked
- verification result
