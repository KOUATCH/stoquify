    ...
    <section id="product" className="section-divider scroll-mt-20 bg-[var(--ink-1)] px-6 py-20 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 lg:grid-cols-[0.86fr_1.14fr] lg:items-end">
          ...
          <figure data-product-command-evidence className="gallery-shot frame-glow overflow-hidden rounded-lg border border-[var(--rule-1)] bg-[var(--ink-2)] shadow-2xl shadow-black/25">
            <div className="relative aspect-[6/5] overflow-hidden bg-black/20 sm:aspect-[36/25]">
              <Image
