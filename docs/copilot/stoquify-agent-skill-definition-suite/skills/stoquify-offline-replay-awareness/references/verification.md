...
# Verification — Offline and Replay Awareness

## Structural

- Validate frontmatter name equals `stoquify-offline-replay-awareness` and contains only `name` and `description`.
- Validate `agents/openai.yaml` and confirm the default prompt invokes `$stoquify-offline-replay-awareness`.
