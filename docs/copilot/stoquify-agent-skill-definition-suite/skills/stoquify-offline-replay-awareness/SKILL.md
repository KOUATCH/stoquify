---
name: stoquify-offline-replay-awareness
description: Use when Stoquify must detect provisional offline state, replay status, conflicts, certification, and finality before explaining or planning consequential work. Use for next-phase Copilot workflows requiring critical-risk controls, evidence, safe failure, and bounded autonomy.
---
...
Detect provisional offline state, replay status, conflicts, certification, and finality before explaining or planning consequential work.

## Scope and non-scope

- Operate as capability `S15` in the Stoquify Copilot registry.
...
4. Read only the relevant source services from: `services/pos`, `services/inventory`, `services/events`, `services/assurance`.
5. Read upstream capability evidence for: stoquify-evidence-grounded-retrieval, stoquify-freshness-trust-evaluator.
...
5. Perform only this skill's bounded responsibility: Detect provisional offline state, replay status, conflicts, certification, and finality before explaining or planning consequential work.
...
- Permitted service domains: `pos`, `inventory`, `events`, `assurance`.
...
Return PROVISIONAL or BLOCKED until server replay and certification complete.
