...
function createErrorNotification(error: ServerActionResult<unknown>['error']): {
  ...
  const categoryConfig: Record<ErrorCategory, string> = {
    ...
    [ErrorCategory.ACCOUNTING]: 'Accounting Error',
    [ErrorCategory.PAYMENT]: 'Payment Error',
    [ErrorCategory.PAYROLL]: 'Payroll Error',
    [ErrorCategory.COMPLIANCE]: 'Compliance Error',
...
function getCategoryString(category: ErrorCategory): NotificationCategory {
  const mapping: Record<ErrorCategory, NotificationCategory> = {
    ...
    [ErrorCategory.EXTERNAL]: 'network',
    ...
    [ErrorCategory.ACCOUNTING]: 'financial',
    [ErrorCategory.PAYMENT]: 'financial',
    [ErrorCategory.PAYROLL]: 'business',
    [ErrorCategory.COMPLIANCE]: 'business',
