...
Generated: 2026-06-19T15:07:44.469Z
...
- Active service-boundary violations: 76
- Allowed test/mock/service findings: 3
- Total callsites scanned: 79

## Active Counts

- ACTION_OWNED_MUTATION: 14
- DIRECT_PRISMA_CALL_OUTSIDE_SERVICE: 31
- DIRECT_PRISMA_DB_IMPORT: 13
- PRISMA_CLIENT_BOUNDARY_COUPLING: 18
...
| 7 | high | DIRECT_PRISMA_DB_IMPORT | `app/[locale]/(dashboard)/dashboard/settings/security/page.tsx` | 6 | `import { db } from "@/prisma/db"` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 7 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `app/[locale]/(dashboard)/dashboard/settings/security/page.tsx` | 160 | `db.user.findFirst({` | db.user.findFirst bypasses the service-owned tenant/RBAC/audit boundary. |
| 7 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `app/[locale]/(dashboard)/dashboard/settings/security/page.tsx` | 197 | `db.account.findFirst({` | db.account.findFirst bypasses the service-owned tenant/RBAC/audit boundary. |
