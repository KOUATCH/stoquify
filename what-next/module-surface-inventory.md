...
- Generated at: 2026-07-22T07:58:16.046Z
- Catalog modules: 20
- Surfaces inventoried: 367
...
- Current active gaps: 10
- Active gap delta: -45
- New gaps: 0
- Resolved gaps: 45

No new module-surface gaps were introduced beyond the saved baseline.
...
| action | brands/getOrgBrands.ts | inventory | inventory.brands.read | inventory.brands.create | inventory.brands.update | inventory.brands.delete | delegated-re-export | mapped, delegated re-export, enforcement candidate | actions/brands/getOrgBrands.ts |
| action | categories/createBulkCategories.ts | inventory | inventory.categories.create | requirePermission | mapped, enforcement candidate | actions/categories/createBulkCategories.ts |
| action | categories/createCategory.ts | inventory | inventory.categories.read | inventory.categories.create | inventory.categories.update | inventory.categories.delete | delegated-re-export | mapped, delegated re-export, enforcement candidate | actions/categories/createCategory.ts |
...
| action | categories/getOrgCategories.ts | inventory | inventory.categories.read | inventory.categories.create | inventory.categories.update | inventory.categories.delete | delegated-re-export | mapped, delegated re-export, enforcement candidate | actions/categories/getOrgCategories.ts |
...
| action | end-of-day-close/branch-daily-close-completion.actions.ts | dashboard | dashboard.read | protect | mapped, enforcement candidate | actions/end-of-day-close/branch-daily-close-completion.actions.ts |
| action | end-of-day-close/branch-daily-close-review.actions.ts | dashboard | branch.daily-close.review | protect | mapped, enforcement candidate | actions/end-of-day-close/branch-daily-close-review.actions.ts |
| action | end-of-day-close/branch-daily-close-sign-off.actions.ts | dashboard | branch.daily-close.sign | protect | mapped, enforcement candidate | actions/end-of-day-close/branch-daily-close-sign-off.actions.ts |
...
| action | inventory/inventoryMovementHistoryActions.ts | inventory | inventory.levels.read | protect | mapped, enforcement candidate | actions/inventory/inventoryMovementHistoryActions.ts |
| action | inventory/inventoryMovementHistoryBackgroundExportActions.ts | inventory | reports.export | protect | mapped, enforcement candidate | actions/inventory/inventoryMovementHistoryBackgroundExportActions.ts |
...
| action | payroll/payroll-country-pack-review-intake.actions.ts | payroll | payroll.runs.calculate | protect | mapped, enforcement candidate | actions/payroll/payroll-country-pack-review-intake.actions.ts |
...
| action | payroll/payroll-setup.actions.ts | payroll | payroll.runs.calculate | protect | mapped, enforcement candidate | actions/payroll/payroll-setup.actions.ts |
| action | pos/cart.actions.ts | pos | pos.use | requirePermission | mapped, enforcement candidate | actions/pos/cart.actions.ts |
| action | pos/cash-payment-history.actions.ts | pos | pos.read | OPERATE_POS | requireAnyPermission | mapped, enforcement candidate | actions/pos/cash-payment-history.actions.ts |
...
| action | purchasing/ap-history.actions.ts | purchasing | finance.reports.export | reports.export | requireAnyPermission | mapped, enforcement candidate | actions/purchasing/ap-history.actions.ts |
...
| action | users/sendInvite.ts | settings | INVITATION_ROLE_GRANT_PERMISSIONS | requireAllPermissions | mapped, enforcement candidate | actions/users/sendInvite.ts |
...
| export | inventory/inventoryMovementHistoryBackgroundExportActions.ts | inventory | reports.export | protect | mapped, enforcement candidate | actions/inventory/inventoryMovementHistoryBackgroundExportActions.ts |
| export | payroll/payroll-register.actions.ts | payroll | payroll.exports.create | protect | mapped, enforcement candidate | actions/payroll/payroll-register.actions.ts |
...
| page | /dashboard/purchases/payables/history | purchasing | purchasing.ap.invoice.view | requirePermission | mapped, enforcement candidate | app/[locale]/(dashboard)/dashboard/purchases/payables/history/page.tsx |
