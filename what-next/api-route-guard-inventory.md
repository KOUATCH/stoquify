...
- Generated at: 2026-08-22T09:02:45.282Z
- Status: ready
- Mode: fail
- API routes inventoried: 16
- Supporting guard evidence files inventoried: 2
- Evidence files inventoried: 18
- Surface kind: api_route=16, guard_evidence=2
- Issues flagged: 0
- Module access: none=13, enforced=5
- Module applicability: not_applicable_public=4, review_required=6, not_applicable_session_claims=1, required=5, delegated_uploadthing_core=1, not_applicable_public_service=1
...
| app/api/supplier-po-envelopes/[envelopeId]/proposals/route.ts | api_route |  | POST | unclassified | none | none |  | none |  |  | review_required | json response | success envelope with safe error envelope |  |
| app/api/supplier-po-envelopes/[envelopeId]/route.ts | api_route |  | GET | unclassified | none | none |  | none |  |  | review_required | json response | success envelope with safe error envelope |  |
