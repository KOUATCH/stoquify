...
- Generated at: 2026-08-01T16:59:37.281Z
- Status: ready
- Mode: fail
- API routes inventoried: 11
- Supporting guard evidence files inventoried: 2
- Evidence files inventoried: 13
- Surface kind: api_route=11, guard_evidence=2
- Issues flagged: 0
- Module access: none=8, enforced=5
- Module applicability: not_applicable_public=4, review_required=1, not_applicable_session_claims=1, required=5, delegated_uploadthing_core=1, not_applicable_public_service=1
