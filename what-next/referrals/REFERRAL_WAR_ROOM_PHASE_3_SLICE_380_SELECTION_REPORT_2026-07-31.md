# Phase 3 / Slice 380 Selection - POS Cash Shortage Production Activation Evidence Dispatch
...
- Add a service-owned `PosCashShortageProductionActivationSlice380EvidenceDispatch` wrapper.
- Preserve the Slice 379 bulletin as source evidence.
