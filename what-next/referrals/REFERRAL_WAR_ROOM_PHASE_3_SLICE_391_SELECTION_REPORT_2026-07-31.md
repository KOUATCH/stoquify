# Phase 3 / Slice 391 Selection - POS Cash Shortage Production Activation Evidence Footnote
...
- Add a service-owned `PosCashShortageProductionActivationSlice391EvidenceFootnote` wrapper.
- Preserve the Slice 390 marginalia as source evidence.
