...
76 migrations found in prisma/migrations
...
Applying migration `20260815120000_supplier_po_acknowledgement_pilot`
Applying migration `20260815130000_governed_master_data_onboarding`
Applying migration `20260815143000_pos_customer_location_scope`
Applying migration `20260815190000_payment_reconciliation_evidence_immutability`
Applying migration `20260816100000_master_data_onboarding_risk_tier`
Applying migration `20260817120000_pos_commit_result_registry`
Applying migration `20260818100000_purchase_receiving_integrity`
Applying migration `20260818120000_governed_delivery_order_to_cash`
Applying migration `20260818120000_pos_electronic_tender_authority`
Applying migration `20260818130000_sales_order_reporting_schema_repair`
Applying migration `20260819100000_purchase_receiving_inspection_control`
Applying migration `20260819120000_purchase_return_credit_evidence_boundary`
Applying migration `20260820100000_supplier_invoice_match_exception_boundary`
Applying migration `20260821210000_payroll_trust_spine_transition_ledger`
...
migrations/
  ...
  └─ 20260815130000_governed_master_data_onboarding/
    └─ migration.sql
  └─ 20260815143000_pos_customer_location_scope/
    └─ migration.sql
  └─ 20260815190000_payment_reconciliation_evidence_immutability/
    └─ migration.sql
  └─ 20260816100000_master_data_onboarding_risk_tier/
    └─ migration.sql
  └─ 20260817120000_pos_commit_result_registry/
    └─ migration.sql
  ...
  └─ 20260818120000_pos_electronic_tender_authority/
    └─ migration.sql
  └─ 20260818130000_sales_order_reporting_schema_repair/
    └─ migration.sql
  └─ 20260819100000_purchase_receiving_inspection_control/
    └─ migration.sql
  └─ 20260819120000_purchase_return_credit_evidence_boundary/
    └─ migration.sql
  └─ 20260820100000_supplier_invoice_match_exception_boundary/
    └─ migration.sql
