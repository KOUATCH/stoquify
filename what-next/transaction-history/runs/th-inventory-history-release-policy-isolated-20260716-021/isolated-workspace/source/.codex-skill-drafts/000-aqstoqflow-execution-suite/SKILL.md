...
description: Run the full numbered AqStoqFlow OHADA SMB implementation suite, select the next skill, enforce gates, and resume safely. Use when executing, sequencing, resuming, auditing, or repairing the full AqStoqFlow numbered skill suite in the AqStoqFlow/OHADA SMB platform, especially when implementing the numbered skill suite with gates, errors, notifications, evidence, and enterprise release discipline.
---

# AqStoqFlow Execution Suite
...
This suite runner selects the next numbered skill from `001` through `017`.

## Focus

Suite orchestration, dependency selection, gate enforcement, and resumption control.
...
- selected skill: `000-aqstoqflow-execution-suite`
- files changed
- gates passed
- gates blocked
- verification result
