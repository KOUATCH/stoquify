---
name: aqstoqflow-module-package-strategy
description: Design AqStoqFlow module package, tier, add-on, trial, upgrade, downgrade, dependency, pricing, and read-only retention strategy. Use when converting canonical modules into commercial SaaS packaging while keeping platform domains separate from sellable modules.
---
...
Package-to-module dependency and pricing model
...
3. Execute only this lane's scope: Define package tiers, add-ons, trials, upgrade/downgrade behavior, dependency pricing, read-only retention, and product-language guardrails.
