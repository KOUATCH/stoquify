---
name: exam-009-aqstoqflow-demo-mock-report-trust-cleaner
description: Exam 009 Demo Mock Report Trust Cleaner remediates AqStoqFlow risk class 009 by remove or quarantine production-visible mock/demo data and make reports show provenance, freshness, certification, and source status. Use when executing the ordered exam risk-remediation suite, hardening this risk area, migrating legacy code into service-owned workflows, adding OHADA controls, or validating this remediation gate.
---

# Exam 009 Demo Mock Report Trust Cleaner

Use this skill to remove or quarantine production-visible mock/demo data and make reports show provenance, freshness, certification, and source status.

## Runtime Boundary

Risk class: Mock inventory/report/monitoring paths and report TODOs can make dashboards appear more trustworthy than the backing evidence allows.
...
- no mock data path.
- not configured monitoring status.
