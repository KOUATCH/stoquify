---
name: stoquify-approval-step-up-coordinator
description: Use when Stoquify must create approval requests, enforce maker-checker separation, require verified step-up authentication, revalidate evidence, and record approval outcomes. Use for now-phase Copilot workflows requiring critical-risk controls, evidence, safe failure, and bounded autonomy.
---

# Approval and Step-Up Coordinator

## Purpose

Create approval requests, enforce maker-checker separation, require verified step-up authentication, revalidate evidence, and record approval outcomes.

## Scope and non-scope

- Operate as capability `S05` in the Stoquify Copilot registry.
...
4. Read only the relevant source services from: `services/auth`, `services/controls`, `services/assurance`, `services/events`.
5. Read upstream capability evidence for: stoquify-trusted-context-resolver, stoquify-permission-entitlement-guard, stoquify-safe-action-planner.
...
5. Perform only this skill's bounded responsibility: Create approval requests, enforce maker-checker separation, require verified step-up authentication, revalidate evidence, and record approval outcomes.
...
- Permitted service domains: `auth`, `controls`, `assurance`, `events`.
...
Pause in APPROVAL_REQUIRED; never self-approve or downgrade policy.
