...
- Generated at: 2026-07-16T03:40:14.987Z
- Catalog modules: 20
- Surfaces inventoried: 354
...
- enforcement candidate: 330
- mapped: 288
- missing permission: 19
...
| action | hris/approval-inbox.actions.ts |  | hris.people.read | protect | unmapped, enforcement candidate | actions/hris/approval-inbox.actions.ts |
| action | hris/compensation.actions.ts |  | hris.people.read | protect | unmapped, enforcement candidate | actions/hris/compensation.actions.ts |
...
| action | hris/payment-destination.actions.ts |  | hris.people.read | protect | unmapped, enforcement candidate | actions/hris/payment-destination.actions.ts |
| action | hris/time-leave.actions.ts |  | hris.people.read | protect | unmapped, enforcement candidate | actions/hris/time-leave.actions.ts |
...
| action | security/step-up-auth.actions.ts |  |  | none | unmapped, missing permission, enforcement candidate | actions/security/step-up-auth.actions.ts |
...
| action | users/sendInvite.ts | settings |  | module-observe | mapped, missing permission, enforcement candidate | actions/users/sendInvite.ts |
...
| report | analytics/analytics/financial-reports.ts | analytics |  | none | mapped, missing permission, enforcement candidate | actions/analytics/analytics/financial-reports.ts |
