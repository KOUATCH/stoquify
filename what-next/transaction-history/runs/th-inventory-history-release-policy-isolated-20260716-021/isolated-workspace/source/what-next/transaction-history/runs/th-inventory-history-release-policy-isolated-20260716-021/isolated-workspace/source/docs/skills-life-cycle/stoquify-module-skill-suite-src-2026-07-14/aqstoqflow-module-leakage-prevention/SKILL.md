---
name: aqstoqflow-module-leakage-prevention
description: Prevent AqStoqFlow inactive-module data leakage through reports, exports, jobs, webhooks, analytics, BI cards, proof surfaces, cross-module dashboards, and scheduled processors. Use when adding source-module checks, redaction, safe partial states, denial tests, and leakage release gates.
---
...
Report, export, job, webhook, analytics, BI, and proof leakage prevention
...
3. Execute only this lane's scope: Register sensitive outputs, require source-module access, define redaction and partial states, and plan leakage tests.
