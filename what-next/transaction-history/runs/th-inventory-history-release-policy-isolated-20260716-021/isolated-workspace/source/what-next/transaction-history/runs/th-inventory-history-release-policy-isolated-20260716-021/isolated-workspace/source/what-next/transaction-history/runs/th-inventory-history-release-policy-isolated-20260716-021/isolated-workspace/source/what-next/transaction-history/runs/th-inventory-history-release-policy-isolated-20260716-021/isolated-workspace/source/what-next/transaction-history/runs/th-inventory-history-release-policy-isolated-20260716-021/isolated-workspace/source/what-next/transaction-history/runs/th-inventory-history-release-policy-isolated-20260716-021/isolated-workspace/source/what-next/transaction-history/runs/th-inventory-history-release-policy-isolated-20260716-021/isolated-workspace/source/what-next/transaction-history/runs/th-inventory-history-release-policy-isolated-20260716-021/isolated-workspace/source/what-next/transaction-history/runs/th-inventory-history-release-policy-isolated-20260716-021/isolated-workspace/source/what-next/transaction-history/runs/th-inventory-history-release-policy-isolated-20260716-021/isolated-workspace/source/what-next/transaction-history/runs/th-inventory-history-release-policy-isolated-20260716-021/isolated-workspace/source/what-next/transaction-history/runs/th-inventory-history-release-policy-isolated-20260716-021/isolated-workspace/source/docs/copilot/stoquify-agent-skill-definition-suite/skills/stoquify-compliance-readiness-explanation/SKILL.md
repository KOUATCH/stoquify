---
name: stoquify-compliance-readiness-explanation
description: Use when Stoquify must explain document, control, declaration, submission, and review state within the exact supported country-pack scope and provenance. Use for next-phase Copilot workflows requiring critical-risk controls, evidence, safe failure, and bounded autonomy.
---
...
Explain document, control, declaration, submission, and review state within the exact supported country-pack scope and provenance.

## Scope and non-scope

- Operate as capability `S26` in the Stoquify Copilot registry.
...
4. Read only the relevant source services from: `services/compliance`, `services/regulatory`, `services/evidence`, `services/assurance`.
5. Read upstream capability evidence for: stoquify-trusted-context-resolver, stoquify-permission-entitlement-guard, stoquify-evidence-grounded-retrieval, stoquify-redaction-disclosure-policy, stoquify-freshness-trust-evaluator, stoquify-country-pack-provenance-resolver, stoquify-close-blocker-navigator.
...
5. Perform only this skill's bounded responsibility: Explain document, control, declaration, submission, and review state within the exact supported country-pack scope and provenance.
...
- Permitted service domains: `compliance`, `regulatory`, `evidence`, `assurance`.
...
Return UNSUPPORTED, SANDBOX, or BLOCKED; never make legal or production claims beyond reviewed evidence.
