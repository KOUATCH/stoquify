...
- Generated at: 2026-07-14T20:10:31.910Z
- Catalog modules: 20
...
- MODULE_SURFACE_UNMAPPED: 34 -> 36 (+2)
- MODULE_SURFACE_UNKNOWN_SLUG: 0 -> 1 (+1)

### New Gaps

| Category | Surface Type | Surface | File | Reason |
|---|---|---|---|---|
| MODULE_SURFACE_UNMAPPED | action | hris/employee.actions.ts | actions/hris/employee.actions.ts | Module-required surface has no canonical module owner. |
| MODULE_SURFACE_UNMAPPED | action | hris/lifecycle.actions.ts | actions/hris/lifecycle.actions.ts | Module-required surface has no canonical module owner. |
| MODULE_SURFACE_UNKNOWN_SLUG | navigation | /dashboard/people | config/sidebar.ts | Surface references a module slug that is not in the canonical catalog. |
