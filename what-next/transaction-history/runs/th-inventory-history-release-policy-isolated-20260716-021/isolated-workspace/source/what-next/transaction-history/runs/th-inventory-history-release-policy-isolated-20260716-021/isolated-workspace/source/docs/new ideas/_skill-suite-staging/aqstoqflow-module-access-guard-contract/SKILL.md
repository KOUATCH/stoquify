---
name: aqstoqflow-module-access-guard-contract
description: Design or implement AqStoqFlow centralized module access guard contracts. Use when creating requireModuleAccess, page/action/API/report/export/job/webhook wrappers, guard-order policy, safe denials, audit evidence, and module-before-data-access checks while preserving observe mode unless explicitly approved.
---
...
Centralized module access guard contract
...
3. Execute only this lane's scope: Define requireModuleAccess shape, wrappers, guard order, RBAC interaction, safe errors, audit event handling, and before-data-access tests.
