---
name: stoquify-close-blocker-navigator
description: Use when Stoquify must rank close findings and missing evidence, propose a safe remediation sequence, and show review or certification consequences. Use for next-phase Copilot workflows requiring critical-risk controls, evidence, safe failure, and bounded autonomy.
---
...
Rank close findings and missing evidence, propose a safe remediation sequence, and show review or certification consequences.

## Scope and non-scope

- Operate as capability `S25` in the Stoquify Copilot registry.
...
4. Read only the relevant source services from: `services/accounting`, `services/assurance`, `services/evidence`, `services/reconciliation`, `services/compliance`.
5. Read upstream capability evidence for: stoquify-trusted-context-resolver, stoquify-permission-entitlement-guard, stoquify-evidence-grounded-retrieval, stoquify-agent-evidence-recorder, stoquify-freshness-trust-evaluator, stoquify-exception-prioritizer, stoquify-cross-domain-root-cause-trace.
...
5. Perform only this skill's bounded responsibility: Rank close findings and missing evidence, propose a safe remediation sequence, and show review or certification consequences.
...
- Permitted service domains: `accounting`, `assurance`, `evidence`, `reconciliation`, `compliance`.
...
Return UNAVAILABLE or BLOCKED for missing domains; never post, reverse, close, reopen, waive, or certify.
