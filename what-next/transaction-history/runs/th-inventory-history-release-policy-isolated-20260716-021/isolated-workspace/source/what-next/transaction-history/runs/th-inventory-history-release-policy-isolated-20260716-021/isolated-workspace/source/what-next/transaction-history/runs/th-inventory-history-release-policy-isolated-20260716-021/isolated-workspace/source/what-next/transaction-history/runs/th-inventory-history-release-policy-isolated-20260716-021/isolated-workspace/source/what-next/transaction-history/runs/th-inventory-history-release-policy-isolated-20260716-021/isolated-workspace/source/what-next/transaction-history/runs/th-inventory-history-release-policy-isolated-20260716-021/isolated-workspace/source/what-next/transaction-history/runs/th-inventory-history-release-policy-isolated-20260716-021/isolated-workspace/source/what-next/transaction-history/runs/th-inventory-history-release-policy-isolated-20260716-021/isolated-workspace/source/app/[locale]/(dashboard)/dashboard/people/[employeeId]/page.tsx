...
export default async function EmployeeProfilePage({
  ...
  let access
  try {
    access = await requireAnyPermission(["hris.people.read"], { resource: "HrisEmployeeProfile" })
  } catch (error) {
    if (error instanceof RbacError) {
      return (
        <DashboardRouteState
          ...
          message="This profile requires HRIS people read permission within the active organization."
