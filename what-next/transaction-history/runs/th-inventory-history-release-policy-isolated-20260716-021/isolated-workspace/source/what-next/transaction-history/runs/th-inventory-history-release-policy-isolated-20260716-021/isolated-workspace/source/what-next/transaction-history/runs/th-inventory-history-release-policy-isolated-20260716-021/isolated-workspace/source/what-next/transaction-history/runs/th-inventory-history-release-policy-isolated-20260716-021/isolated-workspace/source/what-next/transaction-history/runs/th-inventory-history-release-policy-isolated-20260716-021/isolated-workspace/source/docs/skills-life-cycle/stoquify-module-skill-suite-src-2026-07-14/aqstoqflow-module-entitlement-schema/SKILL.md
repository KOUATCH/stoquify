---
name: aqstoqflow-module-entitlement-schema
description: Design AqStoqFlow durable module entitlement schema and migration plans. Use when adding or planning package, subscription, tenant entitlement, entitlement event, source-of-truth, requestedModules migration, dry-run backfill, and observe-mode entitlement architecture without enabling hard enforcement.
---
...
Durable entitlement schema and requestedModules migration
...
3. Execute only this lane's scope: Design additive schema, effective entitlement read model, dry-run migration, unknown requested-module reporting, and entitlement event evidence.
