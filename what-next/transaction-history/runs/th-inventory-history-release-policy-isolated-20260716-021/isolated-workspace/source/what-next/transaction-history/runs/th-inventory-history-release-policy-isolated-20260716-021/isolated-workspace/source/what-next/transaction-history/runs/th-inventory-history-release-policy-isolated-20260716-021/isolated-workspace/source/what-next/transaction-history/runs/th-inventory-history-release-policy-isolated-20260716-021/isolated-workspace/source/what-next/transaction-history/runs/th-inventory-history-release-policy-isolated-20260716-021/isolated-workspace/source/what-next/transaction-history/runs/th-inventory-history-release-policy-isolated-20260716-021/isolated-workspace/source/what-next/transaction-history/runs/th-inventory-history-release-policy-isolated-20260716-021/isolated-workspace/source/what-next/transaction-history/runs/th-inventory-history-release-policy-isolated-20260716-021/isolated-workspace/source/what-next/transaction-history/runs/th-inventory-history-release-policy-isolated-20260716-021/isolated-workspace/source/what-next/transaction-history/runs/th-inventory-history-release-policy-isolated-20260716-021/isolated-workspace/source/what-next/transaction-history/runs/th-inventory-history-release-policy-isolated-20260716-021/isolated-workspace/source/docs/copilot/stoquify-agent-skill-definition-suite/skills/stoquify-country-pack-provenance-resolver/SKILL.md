---
name: stoquify-country-pack-provenance-resolver
description: Use when Stoquify must resolve jurisdiction, effective date, version, expert review, source provenance, environment, language, and production-support state. Use for next-phase Copilot workflows requiring critical-risk controls, evidence, safe failure, and bounded autonomy.
---
...
Resolve jurisdiction, effective date, version, expert review, source provenance, environment, language, and production-support state.

## Scope and non-scope

- Operate as capability `S16` in the Stoquify Copilot registry.
...
4. Read only the relevant source services from: `services/regulatory`, `services/compliance`, `services/tax-rate`, `services/payroll`.
...
5. Perform only this skill's bounded responsibility: Resolve jurisdiction, effective date, version, expert review, source provenance, environment, language, and production-support state.
...
- Permitted service domains: `regulatory`, `compliance`, `tax-rate`, `payroll`.
...
Return UNSUPPORTED or BLOCKED when a current reviewed country pack is absent.
