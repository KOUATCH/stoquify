...
const catalog: ModuleCatalogEntry[] = [
  ...
  },
  {
    ...
    riskLevel: "high",
    core: false,
    routePrefixes: ["/dashboard/purchase-orders", "/dashboard/purchases", "/dashboard/suppliersSystem"],
  ...
  },
  {
    ...
    riskLevel: "critical",
    core: true,
    routePrefixes: ["/dashboard/settings", "/dashboard/change-password", "/dashboard/notifications-demo"],
