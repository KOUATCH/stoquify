...
description: Build the OHADA accounting backbone, chart of accounts, fiscal periods, journal controls, close blockers, and provenance. Use when accounting backbone, SYSCOHADA, journals, chart of accounts, fiscal periods, close blockers, ledger reports, or accountant controls in the AqStoqFlow/OHADA SMB platform, especially when implementing the numbered skill suite with gates, errors, notifications, evidence, and enterprise release discipline.
---
...
Previous required skill: `004-aqstoqflow-business-event-gateway`.
Next recommended skill: `006-aqstoqflow-country-pack-factory`.

## Focus

Double-entry accounting, fiscal close safety, and ledger-backed control center.
