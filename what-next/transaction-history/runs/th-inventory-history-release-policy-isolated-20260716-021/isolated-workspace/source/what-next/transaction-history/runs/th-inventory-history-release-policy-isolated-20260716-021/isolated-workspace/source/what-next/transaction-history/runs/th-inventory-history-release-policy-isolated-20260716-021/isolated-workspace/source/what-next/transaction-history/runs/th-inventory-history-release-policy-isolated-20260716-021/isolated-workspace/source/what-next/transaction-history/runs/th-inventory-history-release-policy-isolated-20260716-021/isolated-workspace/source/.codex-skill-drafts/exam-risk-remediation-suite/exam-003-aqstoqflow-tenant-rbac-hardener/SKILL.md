---
name: exam-003-aqstoqflow-tenant-rbac-hardener
description: Exam 003 Tenant RBAC Hardener remediates AqStoqFlow risk class 003 by harden tenant isolation, trusted organization derivation, RBAC, module gates, fresh-auth, and same-actor controls across services/actions/routes. Use when executing the ordered exam risk-remediation suite, hardening this risk area, migrating legacy code into service-owned workflows, adding OHADA controls, or validating this remediation gate.
---

# Exam 003 Tenant RBAC Hardener

Use this skill to harden tenant isolation, trusted organization derivation, RBAC, module gates, fresh-auth, and same-actor controls across services/actions/routes.

## Runtime Boundary

Risk class: Some legacy actions and routes still accept or pass caller-supplied organization scope, and same-actor segregation is not proven across every sensitive workflow.
