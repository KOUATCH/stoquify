...
description: Add read-only/source-cited AI assistance, proposal mode, blocked unsafe actions, and audit controls over trusted data. Use when AI copilot, assistant, automation, source-cited answers, proposal mode, unsafe action blocking, or accounting guardrails for AI in the AqStoqFlow/OHADA SMB platform, especially when implementing the numbered skill suite with gates, errors, notifications, evidence, and enterprise release discipline.
---
...
Previous required skill: `015-aqstoqflow-country-adapter-pilot`.
Next recommended skill: `017-aqstoqflow-enterprise-release-gate`.

## Focus

Safe AI assistance grounded in trusted platform evidence.
