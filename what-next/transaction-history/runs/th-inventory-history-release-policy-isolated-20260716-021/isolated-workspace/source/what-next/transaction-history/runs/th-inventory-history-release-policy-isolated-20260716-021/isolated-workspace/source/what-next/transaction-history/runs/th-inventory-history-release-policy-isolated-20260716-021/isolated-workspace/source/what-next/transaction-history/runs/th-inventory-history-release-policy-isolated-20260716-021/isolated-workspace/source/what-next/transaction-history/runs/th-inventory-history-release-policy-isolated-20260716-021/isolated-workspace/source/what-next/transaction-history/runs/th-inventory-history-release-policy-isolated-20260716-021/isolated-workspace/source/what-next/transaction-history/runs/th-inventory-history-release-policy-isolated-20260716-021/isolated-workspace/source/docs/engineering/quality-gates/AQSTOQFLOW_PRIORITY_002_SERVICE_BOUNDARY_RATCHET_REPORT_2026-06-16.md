...
Generated: 2026-06-16T13:54:35.254Z
...
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/inventory/inventoryMovementActions.ts` | 5 | `import { db } from "@/prisma/db"` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | medium | PRISMA_CLIENT_BOUNDARY_COUPLING | `actions/inventory/inventoryMovementActions.ts` | 9 | `import type { Prisma } from "@prisma/client"` | UI/action boundaries should consume service DTOs instead of coupling directly to Prisma client types. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 127 | `const lastTransfer = await db.stockTransfer.findFirst({` | db.stockTransfer.findFirst bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 153 | `db.location.findFirst({ where: { id: data.fromLocationId, organizationId: data.organizationId } }),` | db.location.findFirst bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 154 | `db.location.findFirst({ where: { id: data.toLocationId, organizationId: data.organizationId } }),` | db.location.findFirst bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 161 | `const items = await db.item.findMany({` | db.item.findMany bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 171 | `const inventory = await db.inventoryLevel.findUnique({` | db.inventoryLevel.findUnique bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/inventory/inventoryMovementActions.ts` | 189 | `const transfer = await db.stockTransfer.create({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 319 | `db.stockTransfer.findMany({` | db.stockTransfer.findMany bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 326 | `db.stockTransfer.count({ where }),` | db.stockTransfer.count bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 389 | `const transactions = await db.inventoryTransaction.findMany({` | db.inventoryTransaction.findMany bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 546 | `db.inventoryTransaction.aggregate({` | db.inventoryTransaction.aggregate bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 550 | `db.inventoryTransaction.aggregate({` | db.inventoryTransaction.aggregate bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 554 | `db.inventoryTransaction.aggregate({` | db.inventoryTransaction.aggregate bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 558 | `db.inventoryTransaction.aggregate({` | db.inventoryTransaction.aggregate bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/inventory/inventoryMovementActions.ts` | 562 | `db.inventoryTransaction.count({ where }),` | db.inventoryTransaction.count bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/item/items.ts` | 20 | `import { db } from "@/prisma/db"` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | medium | PRISMA_CLIENT_BOUNDARY_COUPLING | `actions/item/items.ts` | 21 | `import { Prisma } from "@prisma/client"` | UI/action boundaries should consume service DTOs instead of coupling directly to Prisma client types. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/item/items.ts` | 70 | `const item = await db.item.findFirst({` | db.item.findFirst bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/item/items.ts` | 110 | `db.item.count({ where }),` | db.item.count bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/item/items.ts` | 111 | `db.item.findMany({` | db.item.findMany bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/item/items.ts` | 134 | `const updated = await db.item.update({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/item/items.ts` | 173 | `const conflict = await db.item.findFirst({` | db.item.findFirst bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/item/items.ts` | 186 | `const updated = await db.item.update({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/item/items.ts` | 220 | `const updated = await db.item.update({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/item/items.ts` | 248 | `const updated = await db.item.update({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/item/items.ts` | 291 | `const existingItem = await tx.item.findFirst({` | tx.item.findFirst bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/item/items.ts` | 298 | `const updatedItem = await tx.item.update({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/item/items.ts` | 356 | `const updated = await db.item.update({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/item/items.ts` | 382 | `const polCount = await db.purchaseOrderLine.count({` | db.purchaseOrderLine.count bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/item/items.ts` | 392 | `await db.item.delete({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/item/listItemsAction.ts` | 5 | `import { db } from '@/prisma/db';` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | medium | PRISMA_CLIENT_BOUNDARY_COUPLING | `actions/item/listItemsAction.ts` | 9 | `import { Prisma } from '@prisma/client';` | UI/action boundaries should consume service DTOs instead of coupling directly to Prisma client types. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/item/listItemsAction.ts` | 103 | `db.item.count({ where }),` | db.item.count bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/item/listItemsAction.ts` | 104 | `db.item.findMany({` | db.item.findMany bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/itemsShow/deleteItem.ts` | 3 | `import { db } from "@/prisma/db";` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/deleteItem.ts` | 12 | `const item = await db.item.findUnique({` | db.item.findUnique bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/itemsShow/deleteItem.ts` | 44 | `const deletedItem = await db.item.delete({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/itemsShow/getBriefItemById.ts` | 2 | `import { db } from "@/prisma/db";` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/getBriefItemById.ts` | 7 | `const item = await db.item.findUnique({` | db.item.findUnique bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/itemsShow/getBriefOrgItems.ts` | 4 | `import { db } from "@/prisma/db";` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/getBriefOrgItems.ts` | 29 | `const rawItems = await db.item.findMany({` | db.item.findMany bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/itemsShow/getOrgItems.ts` | 4 | `import { db } from "@/prisma/db";` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/getOrgItems.ts` | 10 | `const items = await db.item.findMany({` | db.item.findMany bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/itemsShow/getOrgItemsWithInventoryLevels.ts` | 2 | `import { db } from "@/prisma/db";` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/getOrgItemsWithInventoryLevels.ts` | 17 | `const allItemsCount = await db.item.count({` | db.item.count bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/getOrgItemsWithInventoryLevels.ts` | 24 | `const activeItemsCount = await db.item.count({` | db.item.count bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/getOrgItemsWithInventoryLevels.ts` | 33 | `const itemsWithoutImages = await db.item.findMany({` | db.item.findMany bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/itemsShow/getOrgItemsWithInventoryLevelsLocation.ts` | 4 | `import { db } from "@/prisma/db";` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/getOrgItemsWithInventoryLevelsLocation.ts` | 15 | `const items = await db.item.findMany({` | db.item.findMany bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/itemsShow/updateItemBasicInfoById.ts` | 4 | `import { db } from "@/prisma/db";` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/updateItemBasicInfoById.ts` | 12 | `const item = await tx.item.findUnique({` | tx.item.findUnique bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/itemsShow/updateItemBasicInfoById.ts` | 22 | `const updatedItem = await tx.item.update({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/itemsShow/updateItemById.ts` | 3 | `import { db } from "@/prisma/db";` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/updateItemById.ts` | 14 | `const item = await tx.item.findUnique({` | tx.item.findUnique bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/itemsShow/updateItemById.ts` | 43 | `const updatedItem = await tx.item.update({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/itemsShow/updateItemItemDetailsById.ts` | 4 | `import { db } from "@/prisma/db";` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/updateItemItemDetailsById.ts` | 12 | `const item = await tx.item.findUnique({` | tx.item.findUnique bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/itemsShow/updateItemItemDetailsById.ts` | 21 | `const updatedItem = await tx.item.update({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/itemsShow/updateItemPricingById.ts` | 4 | `import { db } from "@/prisma/db";` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/updateItemPricingById.ts` | 12 | `const item = await tx.item.findUnique({` | tx.item.findUnique bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/itemsShow/updateItemPricingById.ts` | 21 | `const updatedItem = await tx.item.update({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
| 1 | high | DIRECT_PRISMA_DB_IMPORT | `actions/itemsShow/updateItemRelationsById.ts` | 4 | `import { db } from "@/prisma/db";` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 1 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/itemsShow/updateItemRelationsById.ts` | 12 | `const item = await tx.item.findUnique({` | tx.item.findUnique bypasses the service-owned tenant/RBAC/audit boundary. |
| 1 | critical | ACTION_OWNED_ECONOMIC_MUTATION | `actions/itemsShow/updateItemRelationsById.ts` | 20 | `const updatedItem = await tx.item.update({` | Server actions must validate and orchestrate only; protected mutations belong in services. |
...
| 3 | medium | PRISMA_CLIENT_BOUNDARY_COUPLING | `actions/purchasing/ap-control.actions.ts` | 4 | `import type { Prisma } from "@prisma/client"` | UI/action boundaries should consume service DTOs instead of coupling directly to Prisma client types. |
| 3 | high | DIRECT_PRISMA_DB_IMPORT | `actions/purchasing/ap-control.actions.ts` | 6 | `import { db } from "@/prisma/db"` | DB clients must be owned by service modules, not App Router, actions, hooks, or components. |
| 3 | high | DIRECT_PRISMA_CALL_OUTSIDE_SERVICE | `actions/purchasing/ap-control.actions.ts` | 74 | `return db.supplierBankChangeRequest.findFirst({` | db.supplierBankChangeRequest.findFirst bypasses the service-owned tenant/RBAC/audit boundary. |
| 3 | medium | PRISMA_CLIENT_BOUNDARY_COUPLING | `app/[locale]/(dashboard)/dashboard/purchases/[id]/page.tsx` | 16 | `import { type PurchaseOrderStatus } from "@prisma/client"` | UI/action boundaries should consume service DTOs instead of coupling directly to Prisma client types. |
| 3 | medium | PRISMA_CLIENT_BOUNDARY_COUPLING | `app/[locale]/(dashboard)/dashboard/purchases/page.tsx` | 18 | `import { type PurchaseOrderStatus } from "@prisma/client"` | UI/action boundaries should consume service DTOs instead of coupling directly to Prisma client types. |
| 4 | medium | PRISMA_CLIENT_BOUNDARY_COUPLING | `hooks/useRecentPurchaseOrderQueries.ts` | 24 | `import { PurchaseOrder, PurchaseOrderStatus } from "@prisma/client";` | UI/action boundaries should consume service DTOs instead of coupling directly to Prisma client types. |
...
| 5 | medium | PRISMA_CLIENT_BOUNDARY_COUPLING | `components/purchase-orders/ModernStatusBadge.tsx` | 3 | `import { PurchaseOrderStatus } from "@prisma/client"` | UI/action boundaries should consume service DTOs instead of coupling directly to Prisma client types. |
...
| 6 | medium | PRISMA_CLIENT_BOUNDARY_COUPLING | `actions/purchaseOrderWorkflow/purchaseOrderSystemAction.ts` | 4 | `import type { PurchaseOrderStatus } from "@prisma/client"` | UI/action boundaries should consume service DTOs instead of coupling directly to Prisma client types. |
