...
description: Create effective-dated country packs for OHADA rules, VAT, payroll, fiscal devices, e-invoicing, and authority adapters. Use when country packs, OHADA country rules, VAT, payroll parameters, fiscal devices, e-invoicing, regulatory adapters, or effective dates in the AqStoqFlow/OHADA SMB platform, especially when implementing the numbered skill suite with gates, errors, notifications, evidence, and enterprise release discipline.
---
...
Previous required skill: `005-aqstoqflow-accounting-control-center`.
Next recommended skill: `007-aqstoqflow-pos-ledger-controls`.

## Focus

Validated country-specific regulatory configuration without hardcoded domain logic.
