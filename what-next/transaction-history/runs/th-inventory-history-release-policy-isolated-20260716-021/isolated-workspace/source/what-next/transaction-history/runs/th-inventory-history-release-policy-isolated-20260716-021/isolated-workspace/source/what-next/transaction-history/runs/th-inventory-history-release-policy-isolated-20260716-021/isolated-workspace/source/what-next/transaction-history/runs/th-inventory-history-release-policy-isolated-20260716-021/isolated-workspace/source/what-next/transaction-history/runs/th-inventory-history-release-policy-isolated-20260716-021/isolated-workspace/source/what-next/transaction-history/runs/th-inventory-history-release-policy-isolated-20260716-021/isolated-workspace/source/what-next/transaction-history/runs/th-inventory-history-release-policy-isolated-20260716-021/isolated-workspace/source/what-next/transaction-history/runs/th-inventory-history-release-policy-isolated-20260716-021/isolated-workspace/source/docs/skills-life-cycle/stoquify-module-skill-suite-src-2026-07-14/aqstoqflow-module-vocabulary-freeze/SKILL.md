---
name: aqstoqflow-module-vocabulary-freeze
description: Freeze AqStoqFlow canonical module vocabulary and dependency semantics. Use when reconciling commercial module slugs, ADR drift, sellable-vs-platform classification, aliases, dependencies, and vocabulary prerequisites before entitlement schema, packaging, guards, UX states, billing, leakage controls, or enforcement work.
---
...
Canonical module vocabulary and dependency freeze
...
3. Execute only this lane's scope: Reconcile COMMERCIAL_MODULE_SLUGS, ADR vocabulary, current catalog metadata, route prefixes, aliases, and dependency semantics.
