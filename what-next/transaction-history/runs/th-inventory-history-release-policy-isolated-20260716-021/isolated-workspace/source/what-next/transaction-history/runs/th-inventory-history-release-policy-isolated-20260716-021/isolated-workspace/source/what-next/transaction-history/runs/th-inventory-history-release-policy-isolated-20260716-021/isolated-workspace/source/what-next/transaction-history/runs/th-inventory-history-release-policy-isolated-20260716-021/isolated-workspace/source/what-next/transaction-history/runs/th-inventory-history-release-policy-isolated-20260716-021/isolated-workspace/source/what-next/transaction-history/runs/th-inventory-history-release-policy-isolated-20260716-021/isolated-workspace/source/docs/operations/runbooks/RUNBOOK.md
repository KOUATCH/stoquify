...
- [CI release gates](ci-release-gates.md)

## Deploy procedure

1. Open a PR. CI provisions isolated PostgreSQL databases and runs `npm run verify:ci`. The required `Verify Repo` check must be green before merging.
