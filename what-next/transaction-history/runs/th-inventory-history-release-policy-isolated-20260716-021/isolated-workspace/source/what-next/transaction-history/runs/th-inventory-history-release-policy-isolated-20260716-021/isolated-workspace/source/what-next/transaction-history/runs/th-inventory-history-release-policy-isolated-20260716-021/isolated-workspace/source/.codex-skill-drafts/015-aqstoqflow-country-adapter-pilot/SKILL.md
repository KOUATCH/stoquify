...
description: Implement the first real country authority adapter with sandbox fixtures, credentials, outage handling, and disable controls. Use when country authority adapter, tax authority API, fiscal device integration, sandbox fixtures, credentials, outages, or regulatory pilot in the AqStoqFlow/OHADA SMB platform, especially when implementing the numbered skill suite with gates, errors, notifications, evidence, and enterprise release discipline.
---

# Country Adapter Pilot
...
Previous required skill: `014-aqstoqflow-offline-pos-sync`.
Next recommended skill: `016-aqstoqflow-ai-copilot-guardrails`.

## Focus

Production-shaped regulatory adapter architecture.
