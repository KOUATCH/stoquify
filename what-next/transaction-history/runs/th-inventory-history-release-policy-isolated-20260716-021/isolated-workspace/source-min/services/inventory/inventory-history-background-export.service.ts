...
export const inventoryHistoryBackgroundExportFiltersSchema = z
  .object({
...
export const enqueueInventoryHistoryBackgroundExportSchema = z
  .object({
    ...
    filters: inventoryHistoryBackgroundExportFiltersSchema.default({}),
...
const jobPayloadSchema = z.object({
  ...
  queryFilters: inventoryHistoryBackgroundExportFiltersSchema,
...
function normalizeQueryFilters(filters: z.infer<typeof inventoryHistoryBackgroundExportFiltersSchema>) {
  return { ...filters }
}

function requestFiltersDigest(
  organizationId: string,
  filters: z.infer<typeof inventoryHistoryBackgroundExportFiltersSchema>,
) {
