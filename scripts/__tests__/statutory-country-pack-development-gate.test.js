...
describe("statutory country-pack development gate", () => {
  ...
  it("blocks if the independent production gate is no longer awaiting expert approval", () => {
    ...
    write(
      root,
      "services/regulatory/country-packs/cameroon.ts",
      `"compliance.eInvoicing": "REQUIRES_EXPERT_REVIEW" productionAutomationAllowed: false adapterReadiness: "REQUIRES_EXPERT_REVIEW" sandboxOnly: true sourceEvidenceHash: "sha256:${artifactHash}"`,
    )
    write(
      root,
